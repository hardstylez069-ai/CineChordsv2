...
import { MOOD_PRESETS, INITIAL_PROGRESSION } from './constants';
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              ...
              <div className="md:col-span-3 flex flex-col space-y-4">
                ...
                {/* Voicing Selector (New Full Width Button Group) */}
                <div>
                  <h3 className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1">
                    Voicing
                  </h3>
              ...
              {/* Right Column: Context (3 cols) */}
              <div className="md:col-span-3 flex flex-col">
                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3 flex items-center gap-2">
                  <Wand2 className="w-3 h-3 text-amber-500" /> Context
                </h3>
                <textarea
                  value={customContext}
                  onChange={(e) => setCustomContext(e.target.value)}
                  placeholder="Describe the scene (e.g., 'A hero rising from defeat')..."
                  className="flex-1 w-full bg-slate-800 border border-slate-700 rounded-lg p-3 text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-amber-500/50 focus:border-amber-500/50 resize-none transition-all min-h-[140px]"
                />
              </div>
            </div>
